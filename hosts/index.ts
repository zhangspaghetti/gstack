...
export const ALL_HOST_CONFIGS: HostConfig[] = [claude, codex, factory, kiro, opencode, slate, cursor, openclaw, copilot];
...
export { claude, codex, factory, kiro, opencode, slate, cursor, openclaw, copilot };
