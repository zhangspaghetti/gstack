...
export interface ApiKeyResolution {
  key: string;
  source: ApiKeySource;
  envVar?: "GSTACK_OPENAI_API_KEY" | "OPENAI_API_KEY";
  envFile?: string;
  warning?: string;
}
...
export function resolveApiKeyInfo(): ApiKeyResolution | null {
  ...
  if (process.env.GSTACK_OPENAI_API_KEY) {
    return { key: process.env.GSTACK_OPENAI_API_KEY, source: "env", envVar: "GSTACK_OPENAI_API_KEY" };
  }
...
export function describeApiKeySource(resolution: ApiKeyResolution): string {
  ...
  if (resolution.envVar === "OPENAI_API_KEY") return "OPENAI_API_KEY environment variable";
  return "GSTACK_OPENAI_API_KEY environment variable";
}
...
export function requireApiKey(): string {
  ...
  if (!resolution) {
    ...
    console.error("  or set GSTACK_OPENAI_API_KEY / OPENAI_API_KEY environment variable");
    console.error("");
